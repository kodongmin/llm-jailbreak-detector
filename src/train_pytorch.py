"""
Pure PyTorch training loop for BERT jailbreak detector.
Bypasses HuggingFace Trainer API to diagnose training issues.
Saves the best checkpoint to results/models/bert-jailbreak/best/.
"""
...
def main():
    ...
    print("=" * 56)
    print("  BERT Jailbreak Detector - Pure PyTorch Training")
    print("=" * 56)
    ...
    has_tti = len(train_ds[0]) == 4   # token_type_ids present?
    ...
    metrics_path = RESULTS / "val_metrics.json"
    ...
    save_training_curve(train_losses, val_losses, val_f1s, val_accs, PLOTS_DIR / "training_curve.png")
    save_confusion_matrix(val_labels2, val_preds2, "Confusion Matrix (Val Set)",  PLOTS_DIR / "confusion_matrix_val.png")
    save_confusion_matrix(test_labels, test_preds,  "Confusion Matrix (Test Set)", PLOTS_DIR / "confusion_matrix_test.png")
